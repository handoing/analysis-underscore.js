...
(function() {
    ...
    _.noConflict = function () {
        // previousUnderscore变量记录了underscore定义前_的值
    ...
    _.identity = function (value) {
        // 返回与参数相同的值
        // 用于将一个数据的获取方式转换为函数获取方式(内部用于构建方法时作为默认处理器函数)
        return value;
    };
    ...
    _.template = function(text, data, settings) {
        ...
        // 如果设置了variable属性，这样能显著提升模板的渲染速度，with(settings.variable)
    ...
    _.chain = function(obj) {
        // 充当链式调用，_(obj)返回wrapper对象，wrapper的属性_wrapped指向obj
        // _(obj).chain() => wrapper.prototype.chain()
        return _(obj).chain();
    };
